...
export const stringToDate = (yyyyMMdd: string) => toDate(parseISO(yyyyMMdd));
export const betweenyyyyMMdd = (
  yyyyMMddEarlier: string,
  yyyyMMddLater: string
) =>
  differenceInCalendarDays(
    stringToDate(yyyyMMddLater),
    stringToDate(yyyyMMddEarlier)
  );

export const addyyyyMMdd = (yyyyMMdd: string, days: number) =>
  formatyyyyMMdd(addDays(days)(stringToDate(yyyyMMdd)));
